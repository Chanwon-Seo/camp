...
public class Main {
    public static void main(String[] args) {
        ...
        // 카테고리가 여행인 책 제목 조회
        bookList.stream()
                .filter(book -> "여행".equals(book.getCategory()))
                .forEach(f -> System.out.println("제목: " + f.getBookName()));
        System.out.println("===================");
        ...
        bookList.stream()
                .filter(book -> "경제".contains(book.getBookName()))
                .forEach(f -> System.out.println("제목: " + f.getBookName()));
        System.out.println("===================");
        //가격이 가장 비싼 책 가격 조회
        double asDouble = bookList.stream()
                .mapToDouble(Book::getPrice)
                .max().getAsDouble();
        System.out.println("금액: " + asDouble);
        System.out.println("===================");
